...
The methods for finding [[Policy|optimal policy]] $\pi^{*}$ can be divided into $3$ categories:
- `Value-Based`
...
### Direct Policy Search
These methods directly search in the space of [[Policy|policies]] without explicitly constructing the optimal value function.

### Hybrid Methods
These methods use the explicitly constructed [[Value Function|value function]] to guide an explicit search in the [[Policy|policy space]].

---
## Policy Evaluation vs Control

> `Policy evaluation` refers to the problem of computing the [[Value Function|value function]] of a given [[Policy|policy]] $\pi$.
>
...
The naive way to evalute the optimal [[Policy|policy]] $\pi$ is to brute-force.
...
---
**Policy Iteration**
Computes the optimal [[Policy|policy]] $\pi^{*}$ by iteratively applying the following two steps:
