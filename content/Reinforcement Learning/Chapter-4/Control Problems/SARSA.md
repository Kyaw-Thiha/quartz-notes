# SARSA
[[SARSA]] can be thought of as a [[Stochastic Approximation(SA)|stochastic approximation]] of the [[Quality Function|Q-function]] by following a [[Markov Policy|policy]] $\pi_{t}$ that is close to [[Greedy Policy|greedy policy]] $\pi_{g}$ but with exploration, and on-policy.
...
> Estimate [[Quality Function|Q-function]] $Q^{\pi}$ for a given [[Markov Policy|policy]] $\pi$ 
...
- **Generalized Policy Iteration**
  Improve the [[Markov Policy|policy]] $\pi$ before $Q$ converges to $Q^{\pi}$.
...
> Note that the [[Markov Policy|policy]] $\pi_{t}$ is often chosen as close to [[Greedy Policy|greedy policy]], but with some amount of exploration: [[Epsilon Greedy Policy]].
> 
...
- [[SARSA]]: the same [[Markov Policy|policy]] $\pi_{t}$ that selects actions (on-policy)
